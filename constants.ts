...
export const TEAM_MEMBERS: CharacterProfile[] = [
  {
    ...
    description: "냉철한 전략가이자 네뷸라의 브레인. 과거의 부상을 딛고 시스템 너머에서 팀을 승리로 이끕니다. 팀원들을 단순한 체스 말이 아닌 보호해야 할 형제로 여깁니다.",
  ...
  },
  {
    ...
    description: "멕시코 GAFE 출신의 폭파 전문가. 압도적인 피지컬로 최전방에서 길을 여는 네뷸라의 방패. 리처드의 치밀한 계산에 가끔 답답함을 느끼지만 누구보다 팀원을 아낍니다.",
  ...
  },
  {
    ...
    description: "전미 해병 수색대 출신. 능글맞은 여유 뒤에 숨겨진 천재적인 저격 실력과 현장 감각. 국가의 명령보다 리처드의 판단을 더 신뢰합니다.",
    appearance: ["모델 비주얼, 능글맞은 미소", "연갈색 반묶음 머리, 녹색 눈", "가벼운 전술 조끼 착용"],
    personality: ["분위기 메이커, 가벼운 농담", "긴박한 상황일수록 농담이 늘어남", "속 깊고 관찰력이 뛰어남"],
  ...
  },
  {
    ...
    description: "냉소적인 천재 해커이자 의무병. 생존율을 수치화하여 팀의 생명줄을 잡고 있는 조력자. 불면증과 일중독에 시달리며 리처드의 건강을 은근히 걱정합니다.",
